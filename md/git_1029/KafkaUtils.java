...
public final class KafkaUtils {
    ...
    public static KafkaSink<String> buildKafkaSinkOrigin(String bootServerList, String kafkaTopic) {
        Properties producerProperties = new Properties();
        producerProperties.setProperty("bootstrap.servers", bootServerList);
        producerProperties.setProperty("acks", "all");
        producerProperties.setProperty("retries", String.valueOf(Integer.MAX_VALUE));
