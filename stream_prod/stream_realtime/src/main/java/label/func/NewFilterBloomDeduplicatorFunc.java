 ...
 * @description: 布隆过滤器
 */
public class NewFilterBloomDeduplicatorFunc extends RichFilterFunction<JSONObject> {

    private static final Logger logger = LoggerFactory.getLogger(NewFilterBloomDeduplicatorFunc.class);

    private final int expectedInsertions;
    private final double falsePositiveRate;
    private transient ValueState<byte[]> bloomState;

    public NewFilterBloomDeduplicatorFunc(int expectedInsertions, double falsePositiveRate) {
